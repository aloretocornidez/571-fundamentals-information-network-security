...
Bytes aes_encrypt(const Byte key[KEY_SIZE], const Byte iv[BLOCK_SIZE],
                  const Container &ptext) {
  Bytes ctext;
...
template <class Container>
Bytes aes_decrypt(const Byte key[KEY_SIZE], const Byte iv[BLOCK_SIZE],
                  const Container &ctext) {
  Bytes rtext;
